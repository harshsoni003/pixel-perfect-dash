    ...
    >
      ...
      <div className="absolute right-0 top-0 bottom-0 w-2/3 overflow-hidden">
        <motion.img
          src={jellyfishImage}
          alt="Jellyfish"
          className="absolute right-0 top-1/2 -translate-y-1/2 h-[120%] w-auto object-cover opacity-80"
          animate={{ y: [0, -10, 0] }}
      ...
      <div className="relative z-10 p-6 flex flex-col justify-between h-full">
        <div>
          ...
          <h2 className="text-2xl font-bold text-foreground mb-4">Mark Johnson</h2>
